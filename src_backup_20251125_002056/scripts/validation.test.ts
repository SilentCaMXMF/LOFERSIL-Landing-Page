...
describe("Validation Functions", () => {
  describe("validateName", () => {
    ...
    it("should return correct error messages", () => {
      ...
      expect(validateName("A".repeat(101)).error).toBe(
        VALIDATION_MESSAGES.name.tooLong,
      );
      expect(validateName("John123").error).toBe(
        VALIDATION_MESSAGES.name.invalidChars,
      );
    });
  });
  ...
  describe("validateEmail", () => {
    ...
    it("should reject invalid emails", () => {
      ...
      expect(validateEmail("a".repeat(250) + "@example.com").isValid).toBe(
        false,
      );
    });
    ...
    it("should return correct error messages", () => {
      ...
      expect(validateEmail("userexample.com").error).toBe(
  ...
  describe("validatePhone", () => {
    ...
    it("should return correct error messages", () => {
      expect(validatePhone("123").error).toBe(
        VALIDATION_MESSAGES.phone.invalid,
      );
      expect(validatePhone("1".repeat(21)).error).toBe(
        VALIDATION_MESSAGES.phone.tooLong,
      );
    });
  });
  ...
  describe("validateMessage", () => {
    it("should validate valid messages", () => {
      expect(
        validateMessage("This is a valid message with enough content.").isValid,
      ).toBe(true);
    ...
    it("should return correct error messages", () => {
      expect(validateMessage("").error).toBe(
        VALIDATION_MESSAGES.message.required,
      );
      expect(validateMessage("Hi").error).toBe(
        VALIDATION_MESSAGES.message.tooShort,
      );
      expect(validateMessage("A".repeat(2001)).error).toBe(
        VALIDATION_MESSAGES.message.tooLong,
      );
    });
  });
