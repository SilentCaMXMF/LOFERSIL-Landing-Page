...
import { UIManager } from "../../../../src/scripts/modules/UIManager.js";
...
describe("UIManager", () => {
  ...
  describe("UI Methods", () => {
    it("should handle showLoading without errors", () => {
      ...
      expect(() =>
        uiManager.showLoading(mockElement as HTMLElement),
      ).not.toThrow();
    });
    ...
    it("should handle hideLoading without errors", () => {
      ...
      expect(() =>
        uiManager.hideLoading(mockElement as HTMLElement),
      ).not.toThrow();
    });
    ...
    it("should handle toggleVisibility without errors", () => {
      ...
      expect(() =>
        uiManager.toggleVisibility(mockElement as HTMLElement, true),
      ).not.toThrow();
    });
  });
});
