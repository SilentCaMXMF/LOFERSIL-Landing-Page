...
import {
  ...
  CodeChanges,
  ResolutionResult,
} from "../modules/github-issues/AutonomousResolver";
import { OpenCodeAgent } from "../modules/OpenCodeAgent";
import { WorktreeManager } from "../modules/github-issues/WorktreeManager";
import { IssueAnalysis } from "../modules/github-issues/IssueAnalyzer";

// Mock dependencies
vi.mock("../modules/modules/OpenCodeAgent");
vi.mock("../modules/modules/github-issues/WorktreeManager");
