...
import { IssueAnalyzer } from "../modules/IssueAnalyzer";
import { AutonomousResolver } from "../modules/AutonomousResolver";
import { CodeReviewer } from "../modules/CodeReviewer";
import { PRGenerator } from "../modules/PRGenerator";

// Mock all dependencies
vi.mock("../modules/modules/IssueAnalyzer");
vi.mock("../modules/modules/AutonomousResolver");
vi.mock("../modules/modules/CodeReviewer");
vi.mock("../modules/modules/PRGenerator");
