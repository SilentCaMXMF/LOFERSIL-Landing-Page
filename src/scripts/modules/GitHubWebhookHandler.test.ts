...
import { GitHubWebhookHandler, GitHubWebhookPayload } from './GitHubWebhookHandler';
...
describe('GitHubWebhookHandler', () => {
  ...
  describe('Configuration Validation', () => {
    ...
    it('should reject missing webhook secret', () => {
      expect(() => new GitHubWebhookHandler({
        ...validConfig,
        webhookSecret: '',
  ...
  describe('Event Validation', () => {
    ...
    it('should validate supported issue actions', () => {
      const actions = ['opened', 'edited', 'closed', 'reopened', 'assigned', 'unassigned', 'labeled', 'unlabeled'];
  ...
  describe('Webhook Handling', () => {
    ...
    it('should reject webhook with unsupported event type', async () => {
      ...
      const result = await handler.handleWebhook(headers, rawBody, 'unsupported');
    ...
    it('should reject payload exceeding size limit', async () => {
      ...
      const result = await largeHandler.handleWebhook(headers, largeBody, 'issues');
    ...
    it('should handle malformed JSON payload', async () => {
      ...
      const result = await handler.handleWebhook(headers, malformedBody, 'issues');
  ...
  describe('Utility Methods', () => {
    it('should return supported actions', () => {
      ...
      expect(actions).toEqual(['opened', 'edited', 'closed', 'reopened', 'assigned', 'unassigned', 'labeled', 'unlabeled']);
    });
