...
////   setupScheduledTasks,
//// } from "./src/scripts/modules/GitHubIssuesReviewerMain.js";
...
////} catch (error) {
////  console.warn(
////    "⚠️ GitHub Issues Reviewer System integration failed:",
////    error.message,
//  );
...
app.listen(PORT, () => {
  ...
  console.log(
    `📊 GitHub Issues Reviewer API available at http://localhost:${PORT}/api/tasks`,
  );
  console.log(
    `🔧 System health endpoint at http://localhost:${PORT}/api/system/health`,
  );
  console.log(
    `📈 Statistics endpoint at http://localhost:${PORT}/api/tasks/statistics`,
  );
});
