 ...
 */
export async function loadEnvVariables(config = {}) {
 ...
 */
export async function getEnvVariable(varName, config = {}) {
 ...
 */
export async function getRequiredEnvVariable(varName, config = {}) {
 ...
 */
export async function getRequiredEnvVariables(varNames, config = {}) {
    const result = {};
 ...
 */
export async function getApiKey(apiKeyName, config = {}) {
