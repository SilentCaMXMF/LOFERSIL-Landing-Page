...
export class MCPResources {
    ...
    async listResources(forceRefresh = false) {
        ...
        try {
            ...
            this.logger.error('MCPResources', 'Failed to list MCP resources', error);
    ...
    async readResource(uri) {
        try {
            ...
            this.logger.error('MCPResources', `Failed to read resource '${uri}'`, error);
            throw error;
        }
    }
    async readMultipleResources(uris) {
