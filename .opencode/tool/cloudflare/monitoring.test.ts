...
describe('CloudflareMonitoring', () => {
  ...
  describe('getUsageStats', () => {
    ...
    it('should return daily usage statistics', () => {
      ...
      expect(stats[0].modelUsage).toHaveProperty('@cf/black-forest-labs/flux-1-schnell', 1);
      expect(stats[0].modelUsage).toHaveProperty('@cf/stabilityai/stable-diffusion-xl-base-1.0', 1);
    });
  });
